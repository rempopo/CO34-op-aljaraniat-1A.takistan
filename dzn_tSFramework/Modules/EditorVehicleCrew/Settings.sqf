...
tSF_EVC_OPFOR_Side	= independent;
tSF_EVC_OPFOR_CrewSkill	= 0.75;
tSF_EVC_OPFOR_CrewKit	= "kit_jihadists_fighter";
tSF_EVC_OPFOR_HoldType	= "full frontal";


#define	CREW_CONFIG_TABLE tSF_EVC_CrewConfig = [
#define	CREW_CONFIG_TABLE_END ];
#define OPFOR_CREW_CONFIG_DEFAULT tSF_EVC_OPFOR_Side,tSF_EVC_OPFOR_CrewSkill,tSF_EVC_OPFOR_CrewKit,tSF_EVC_OPFOR_HoldType
